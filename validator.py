...
def _extract_gpt_info_from_solution(work_dir: Path) -> tuple[str | None, str]:
    """Extract model hint and instructions from an extracted solution ZIP.

    Returns (model_hint, instructions).
    """
